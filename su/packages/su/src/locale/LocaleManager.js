...
Ext.define('SU.locale.LocaleManager', {
    ...
    loadPropertiesFileResultHandler: function (result) {
        ...
        if (!!window.DEBUG_LOCALE)
            console.log(
                '[LOCALE] LocaleManager - Properties file loaded: ' + me.locales.findRecord('id', me.locale).get('url')
            );
        //</debug>
    ...
    updateClient: function (clientModel) {
        ...
        try {
            ...
            if (!!window.DEBUG_LOCALE)
                console.log(
                    '[LOCALE] ERROR: LocaleManager - Error updating client [client: ' +
                        client.getId() +
                        ', method: ' +
                        method +
                        ', key: ' +
    ...
    registerClient: function (clientModel) {
        ...
        if (!!window.DEBUG_LOCALE)
            console.log(
                '[LOCALE] LocaleManager - Registering client component [client: ' +
                    clientModel.get('client').getId() +
                    ', method: ' +
                    clientModel.get('method') +
                    ', key: ' +
                    clientModel.get('key') +
                    clientModel.get('allowEmpty') +
                    ']'
            );
        //</debug>
    ...
    unregisterClient: function (clientModel) {
        ...
        if (!!window.DEBUG_LOCALE)
            console.log(
                '[LOCALE] LocaleManager - Unregistering client component [client: ' +
                    clientModel.get('client').getId() +
                    ', method: ' +
                    clientModel.get('method') +
                    ', key: ' +
